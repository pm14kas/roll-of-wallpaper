...
private:
	double calc(std::vector<KeyValue> varmap, std::string f) //varmap - список переменных, f - строка, которую необходимо распарсить (каждый раз разная при рекурсивном подходе)
	{
